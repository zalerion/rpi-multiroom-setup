...
#sudo mount -t cifs  //192.168.0.1/fritznas/Volume /mnt/share -o vers=1.0,sec=ntlm,user=$user,password=$pwd
sudo mount -t cifs  //192.168.0.1/fritznas/Volume /mnt/share -o noserverino,vers=3.0,sec=ntlm,user=$user,password=$pwd
...
#echo "sudo mount -t cifs  //192.168.0.1/fritznas/Volume /mnt/share -o vers=1.0,sec=ntlm,user=$user,password=$pwd" > /etc/automount.sh
echo "sudo mount -t cifs  //192.168.0.1/fritznas/Volume /mnt/share -o noserverino,vers=3.0,sec=ntlm,user=$user,password=$pwd" > /etc/automount.sh
